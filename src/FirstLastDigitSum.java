 ...
 * sumFirstAndLastDigit(252); →should return 4, the first digit is 2 and the last is 2 which gives us 2+2 and the sum
 * is 4. * sumFirstAndLastDigit(257); →should return 9, the first digit is 2 and the last is 7 which gives us 2+7 and
 * the sum is 9. * sumFirstAndLastDigit(0); → should return 0, the first digit and the last digit is 0 since we only
...
public class FirstLastDigitSum {
    public static void main(String[] args) {
        ...
        int result = firstLastDigitSum.sumFirstAndLastDigit(n1);
        System.out.println("The sum of the first and last number is " + result);
        scanner.close();
    }
